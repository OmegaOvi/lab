...
function createResultTable() {
    ...
    const algorithmNames = ['FCFS', 'SJF', 'SJF (Preemptive)', 'Priority', 'Priority (Preemptive)', 'Round Robin'];
// Example data, replace these with your actual calculated values
const avgTurnaroundTimes = [avgWaitingTimeFCFS, avgWaitingTimeSJFNonPre, avgWaitingTimeSJFPre, avgWaitingTimePriorityNonPre, avgWaitingTimePriorityPre, avgWaitingTimeRoundRobin]; // Replace with your actual data
const avgWaitingTimes = [avgTurnaroundTimeFCFS, avgTurnaroundTimeSJFNonPre, avgTurnaroundTimeSJFPre,avgTurnaroundTimePriorityNonPre, avgTurnaroundTimePriorityPre, avgTurnaroundTimeRoundRobin]; // Replace with your actual data
...
function findBest(checked) {
    ...
    let algorithms = ["FCFS", "SJF", "SJF(Preemptive)", "Priority", "Priority(Preemptive)", "Round Robin"];
